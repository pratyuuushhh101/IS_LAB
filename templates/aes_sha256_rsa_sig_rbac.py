"""
==============================================================================
Role-Based Crypto System Template (AES + SHA256 + RSA Signature)
Purpose: Ready-to-run template for exam questions involving RBAC and AES.
...
# CUSTOMIZE: Global AES Key and IV for the system
CIPHER_KEY = b"1234567890123456" # 16 bytes for AES-128
...
def aes_encrypt(data_bytes):
    ...
    """
    # CUSTOMIZE: AES-CBC Encryption
    # Create AES cipher in CBC mode with the key and IV
    cipher = AES.new(CIPHER_KEY, AES.MODE_CBC, IV)
    # Pad data to AES block size (16 bytes) and encrypt
...
def aes_decrypt(cipher_bytes):
    ...
    """
    # CUSTOMIZE: AES-CBC Decryption
    # Recreate AES cipher for decryption
    cipher = AES.new(CIPHER_KEY, AES.MODE_CBC, IV)
...
def uploader_action(username):
    ...
    enc_data = aes_encrypt(data_bytes)
